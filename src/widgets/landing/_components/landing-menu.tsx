...
const LINKS = [
  ...
  },
  {
    href: "/services",
    label: "Услуги",
    desc: "Прогулки, дни рождения, корпоративы и фотосессии — восемь сценариев на воде.",
  },
  {
    href: "/ceny",
    label: "Цены",
  ...
  },
  {
    href: "/otzyvy",
    label: "Отзывы",
    desc: "Истории гостей: дни рождения, корпоративы и вечера на воде.",
  },
  {
    href: "/faq",
    label: "Вопросы",
  ...
  },
  {
    href: "/sertifikaty",
    label: "Сертификаты",
    desc: "Подарочный сертификат на прогулку — впечатление вместо вещи, от 150 BYN.",
  },
];
