// Just the brand mark — three sails over the wave, exported from Figma. Used
// by <Logo /> as the lockup mark, and standalone in places like buttons where
// the wrapped Logo (with ripple + wordmark) would be too heavy.
//
// Two-tone via --logo-ink (fallback currentColor) — the «navy» sails follow
// whatever ink the consuming context sets. Light-theme paper contexts override
// to navy + grey hand-drawn outline (--logo-stroke); dark / over-hero contexts
// keep currentColor and transparent stroke. The scarlet sail is always fixed.
