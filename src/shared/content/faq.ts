...
export const FAQ: ReadonlyArray<FaqItem> = [
  ...
  },
  {
    ...
    answer: "1 час. Дальше — по целым часам.",
    tags: ["booking", "general"],
  },
  {
    id: "bad-weather",
    ...
    answer:
      "Следим за прогнозом: в городе дождь — на воде часто ясно. Если льёт — пережидаем в закрытой каюте под пледами. За пару часов до выхода созвонимся, сверим погоду и решим вместе. Если капитан сочтёт выход небезопасным — перенесём на другую дату без штрафа.",
    tags: ["booking", "general"],
  },
  {
    id: "year-round",
  ...
  },
  {
    ...
    answer:
      "EVA — самая камерная (до 6 гостей), ALFA и MARIO — универсальные на 8 человек, BRAVO — флагман с премиум-мебелью для VIP-мероприятий и крупных корпоративов.",
    tags: ["fleet", "general"],
  },
  {
    id: "capacity",
