...
export const REVIEWS: ReadonlyArray<Review> = [
  {
    ...
    rating: 5,
    date: "2025-07-18",
    text: "Отмечали годовщину отношений на EVA — лучшее решение за последние несколько лет. Капитан Артём посоветовал маршрут с красивым закатом, а команда подготовила всё так, что нам осталось только наслаждаться. Обязательно вернёмся следующим летом.",
  ...
  },
  {
    ...
    rating: 5,
    date: "2025-06-22",
    text: "Заказывали яхту для парной фотосессии. Фотограф был в восторге от фактуры — паруса, палуба, блики воды. Яхту подготовили как просили, команда не мешала съёмке. Фотографии увидели гости — все спрашивают, где мы снимали.",
  ...
  },
  {
    ...
    rating: 5,
    date: "2025-07-30",
    text: "Корпоратив на BRAVO для 10 человек. Заказывали с кейтерингом через Минское море — цены адекватные, еду принесли ровно к началу. Коллеги до сих пор вспоминают. Отдельное спасибо за то, что объяснили технику безопасности перед выходом.",
