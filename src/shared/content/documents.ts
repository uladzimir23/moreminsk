// Юридические документы — спарсены со старого moreminsk.by/documents (Tilda).
// Pavel может актуализировать в Cursor/CMS позже. Каждый body — массив параграфов;
// строки в ALL CAPS воспринимаются как заголовки (DocumentsPage стилит крупнее).

export type LegalDocument = {
  slug: "oferta" | "safety" | "consent";
  title: string;
  lead: string;
  paragraphs: ReadonlyArray<string>;
};

export const DOCUMENTS: ReadonlyArray<LegalDocument> = [
  {
    slug: "oferta",
